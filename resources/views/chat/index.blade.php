    ...
    <div x-data="chatApp()">
        ...
        <div class="flex h-screen">
            ...
            <div class="w-64 bg-gray-900 text-white p-4 flex flex-col">
                <button @click="newChat" class="bg-blue-600 hover:bg-blue-700 py-2 px-4 rounded mb-4 transition">
                    + New Chat
                </button>
                ...
                <div class="border-t border-gray-700 pt-4 mt-4">
                    ...
                    @else
                        ...
                        <button @click="showAuthModal = true" class="text-sm text-blue-400 hover:text-blue-300 mt-1">
                            Login / Register
                        </button>
                    @endauth
                </div>
                ...
                <div class="bg-white border-b px-6 py-4 flex items-center justify-between">
                    ...
                    @guest
                        <div class="flex items-center gap-3">
                            ...
                            <button @click="showAuthModal = true" class="text-sm text-blue-600 hover:text-blue-700 underline">
                                Login / Register
                            </button>
                        </div>
                    @endguest
