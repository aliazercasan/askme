        ...
        <div class="bg-white/80 backdrop-blur-xl rounded-3xl shadow-2xl p-8 sm:p-10 border border-slate-200/50">
            <div class="text-center mb-8">
                ...
                <p class="text-slate-600">
                    ...
                    <a href="/register" class="font-semibold text-indigo-600 hover:text-indigo-700 transition-colors">
                        Sign up
                    </a>
                </p>
            </div>
            
            <form class="space-y-5" action="/login" method="POST" @submit="loading = true">
                @csrf
